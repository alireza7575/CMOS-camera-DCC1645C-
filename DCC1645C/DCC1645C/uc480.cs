...
public class uc480
{
	...
	// ***********************************************
	// values for UC480_ETH_DEVICE_INFO_HEARTBEAT::dwStatus
	// ***********************************************
	...
	public struct UC480_ETH_ADAPTER_INFO
	{
		...
		public ushort							wPacketFilter;			// Setting for the Incoming Packets Filter. see UC480_ETH_PACKETFILTER_SETUP enum above.
	}
	...
	// --------------------------------------------------------------------
    // new datatypes only valid for uc480 ETH - END
	// --------------------------------------------------------------------
	
	
	// ***********************************************
    // exports from uc480.dll
	// ***********************************************	
    [DllImport(DRIVER_DLL_NAME, EntryPoint = "is_StopLiveVideo",CallingConvention=CallingConvention.Cdecl)]			// is_StopLiveVideo
	private static extern int is_StopLiveVideo(int hCam, int mode);		
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_FreezeVideo",CallingConvention=CallingConvention.Cdecl)]				// is_FreezeVideo
	private static extern int is_FreezeVideo(int hCam, int wait);	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_CaptureVideo",CallingConvention=CallingConvention.Cdecl)]				// is_CaptureVideo
	private static extern int is_CaptureVideo (int hCam, int Wait);    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_IsVideoFinish",CallingConvention=CallingConvention.Cdecl)]				// is_IsVideoFinish
	private static extern int is_IsVideoFinish (int hCam, ref int pBool);    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_HasVideoStarted",CallingConvention=CallingConvention.Cdecl)]			// is_HasVideoStarted
	private static extern int is_HasVideoStarted (int hCam, ref int pBool);
		
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetBrightness",CallingConvention=CallingConvention.Cdecl)]				// is_SetBrightness
	private static extern int is_SetBrightness (int hCam, int bright);    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetContrast",CallingConvention=CallingConvention.Cdecl)]				// is_SetContrast
	private static extern int is_SetContrast (int hCam, int Cont);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetGamma",CallingConvention=CallingConvention.Cdecl)]					// is_SetGamma
	private static extern int is_SetGamma (int hCam, int mode);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_AllocImageMem",CallingConvention=CallingConvention.Cdecl)]				// is_AllocImageMem
	private static extern int is_AllocImageMem (int hCam, int width, int height, int bits, ref IntPtr ppcImg, ref int pid);	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_FreeImageMem",CallingConvention=CallingConvention.Cdecl)]				// is_FreeImageMem
	private static extern int is_FreeImageMem (int hCam, IntPtr pImgMem, int id);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetImageMem",CallingConvention=CallingConvention.Cdecl)]				// is_SetImageMem
	private static extern int is_SetImageMem (int hCam, IntPtr pcImg, int id);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetImageMem",CallingConvention=CallingConvention.Cdecl)]				// is_GetImageMem
	private static extern int is_GetImageMem (int hCam, ref IntPtr ppMem);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetActiveImageMem",CallingConvention=CallingConvention.Cdecl)]			// is_GetActiveImageMem
	private static extern int is_GetActiveImageMem (int hCam, ref IntPtr ppcMem, ref int pnID);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_InquireImageMem",CallingConvention=CallingConvention.Cdecl)]			// is_InquireImageMem
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetImageMemPitch",CallingConvention=CallingConvention.Cdecl)]			// is_GetImageMemPitch
	private static extern int is_GetImageMemPitch (int hCam, ref int pPitch);
		
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetAllocatedImageMem",CallingConvention=CallingConvention.Cdecl)]		// is_SetAllocatedImageMem
	private static extern int is_SetAllocatedImageMem (int hCam, int width, int height, int bpp, IntPtr pImgMem, ref int id);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SaveImageMem",CallingConvention=CallingConvention.Cdecl)]				// is_SaveImageMem
	private static extern int is_SaveImageMem (int hCam, byte[] strFile, IntPtr pMem, int nId);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_CopyImageMem",CallingConvention=CallingConvention.Cdecl)]				// is_CopyImageMem
	private static extern int is_CopyImageMem (int hCam, IntPtr pcSource, int nID, IntPtr pcDest);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_CopyImageMemLines",CallingConvention=CallingConvention.Cdecl)]			// is_CopyImageMemLines
	private static extern int is_CopyImageMemLines (int hCam, IntPtr pcSource, int nID, int nLines, IntPtr pcDest);
		
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_AddToSequence",CallingConvention=CallingConvention.Cdecl)]				// is_AddToSequence
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetActSeqBuf",CallingConvention=CallingConvention.Cdecl)]				// is_GetActSeqBuf
	private static extern int is_GetActSeqBuf (int hCam, ref int pnNum, ref IntPtr ppcMem, ref IntPtr ppcMemLast);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_LockSeqBuf",CallingConvention=CallingConvention.Cdecl)]				// is_LockSeqBuf
	private static extern int is_LockSeqBuf (int hCam, int nNum, IntPtr pcMem);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_UnlockSeqBuf",CallingConvention=CallingConvention.Cdecl)]				// is_UnlockSeqBuf
	private static extern int is_UnlockSeqBuf (int hCam, int nNum, IntPtr pcMem);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetImageSize",CallingConvention=CallingConvention.Cdecl)]				// is_SetImageSize
	private static extern int is_SetImageSize (int hCam, int X, int Y);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetImagePos",CallingConvention=CallingConvention.Cdecl)]				// is_SetImagePos
	private static extern int is_SetImagePos (int hCam, int X, int Y);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetError",CallingConvention=CallingConvention.Cdecl)]					// is_GetError
	private static extern int is_GetError (int hCam, ref int pErr, IntPtr ppcErr);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetErrorReport",CallingConvention=CallingConvention.Cdecl)]			// is_SetErrorReport
	private static extern int is_SetErrorReport (int hCam, int mode);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ReadEEPROM",CallingConvention=CallingConvention.Cdecl)]				// is_ReadEEPROM
	private static extern int is_ReadEEPROM (int hCam, int Adr, byte[] pcString, int count);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_WriteEEPROM",CallingConvention=CallingConvention.Cdecl)]				// is_WriteEEPROM
	private static extern int is_WriteEEPROM (int hCam, int Adr, byte[] pcString, int count);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SaveImage",CallingConvention=CallingConvention.Cdecl)]					// is_SaveImage
	private static extern int is_SaveImage (int hCam, byte[] pcString);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetColorMode",CallingConvention=CallingConvention.Cdecl)]				// is_SetColorMode
	private static extern int is_SetColorMode (int hCam, int ColorMode);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetColorDepth",CallingConvention=CallingConvention.Cdecl)]             // is_GetColorDepth
	private static extern int is_GetColorDepth (int hCam, ref int  pnCol, ref int pnColMode);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_RenderBitmap",CallingConvention=CallingConvention.Cdecl)]				// is_RenderBitmap
	private static extern int is_RenderBitmap (int hCam, int MemID, int hWnd, int mode);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetDisplayMode",CallingConvention=CallingConvention.Cdecl)]			// is_SetDisplayMode
	private static extern int is_SetDisplayMode(int hCam, int mode );    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetDC",CallingConvention=CallingConvention.Cdecl)]						// is_GetDC
	private static extern int is_GetDC (int hCam, ref int phDC);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ReleaseDC",CallingConvention=CallingConvention.Cdecl)]					// is_ReleaseDC
	private static extern int is_ReleaseDC (int hCam, int hDC);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_UpdateDisplay",CallingConvention=CallingConvention.Cdecl)]				// is_UpdateDisplay
	private static extern int is_UpdateDisplay (int hCam);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetDisplayPos",CallingConvention=CallingConvention.Cdecl)]				// is_SetDisplayPos
	private static extern int is_SetDisplayPos (int hCam, int X, int Y);
	// Direct Draw
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_LockDDOverlayMem",CallingConvention=CallingConvention.Cdecl)]			// is_LockDDOverlayMem
	private static extern int is_LockDDOverlayMem (int hCam, ref IntPtr ppMem, ref int pPitch);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_UnlockDDOverlayMem",CallingConvention=CallingConvention.Cdecl)]		// is_UnlockDDOverlayMem
	private static extern int is_UnlockDDOverlayMem(int hCam);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_LockDDMem",CallingConvention=CallingConvention.Cdecl)]					// is_LockDDMem
	private static extern int is_LockDDMem (int hCam, ref IntPtr ppMem, ref int pPitch);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_UnlockDDMem",CallingConvention=CallingConvention.Cdecl)]				// is_UnlockDDMem
	private static extern int is_UnlockDDMem(int hCam);    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetDDUpdateTime",CallingConvention=CallingConvention.Cdecl)]				// is_SetDDUpdateTime
	private static extern int is_SetDDUpdateTime (int hCam, int ms);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_EnableDDOverlay",CallingConvention=CallingConvention.Cdecl)]				// is_EnableDDOverlay
	private static extern int is_EnableDDOverlay (int hCam);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_DisableDDOverlay",CallingConvention=CallingConvention.Cdecl)]				// is_DisableDDOverlay
	private static extern int is_DisableDDOverlay (int hCam);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ShowDDOverlay",CallingConvention=CallingConvention.Cdecl)]				// is_ShowDDOverlay
	private static extern int is_ShowDDOverlay (int hCam);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_HideDDOverlay",CallingConvention=CallingConvention.Cdecl)]				// is_HideDDOverlay
	private static extern int is_HideDDOverlay (int hCam);  
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetDDOvlSurface",CallingConvention=CallingConvention.Cdecl)]			// is_GetDDOvlSurface
	private static extern int is_GetDDOvlSurface(int hCam, ref IntPtr ppDDSurf);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetKeyColor",CallingConvention=CallingConvention.Cdecl)]				// is_SetKeyColor
	private static extern int is_SetKeyColor (int hCam, int r, int g, int b);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_StealVideo",CallingConvention=CallingConvention.Cdecl)]				// is_StealVideo
	private static extern int is_StealVideo (int hCam, int Wait);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetHwnd",CallingConvention=CallingConvention.Cdecl)]					// is_SetHwnd
	private static extern int is_SetHwnd (int hCam, int hWnd);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetVsyncCount",CallingConvention=CallingConvention.Cdecl)]             // is_GetVsyncCount
	private static extern int is_GetVsyncCount (int hCam, ref long pIntr, ref long pActIntr);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetOsVersion",CallingConvention=CallingConvention.Cdecl)]				// is_GetOsVersion
	private static extern int is_GetOsVersion();
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetDLLVersion",CallingConvention=CallingConvention.Cdecl)]			    // is_GetDLLVersion
	private static extern int is_GetDLLVersion ();
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_InitEvent",CallingConvention=CallingConvention.Cdecl)]					// is_InitEvent
	private static extern int is_InitEvent (int hCam, int hEv, int which);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ExitEvent",CallingConvention=CallingConvention.Cdecl)]					// is_ExitEvent
	private static extern int is_ExitEvent (int hCam, int which);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_EnableEvent",CallingConvention=CallingConvention.Cdecl)]				// is_EnableEvent
	private static extern int is_EnableEvent (int hCam, int which);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_DisableEvent",CallingConvention=CallingConvention.Cdecl)]				// is_DisableEvent
	private static extern int is_DisableEvent (int hCam, int which);
		
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetIO",CallingConvention=CallingConvention.Cdecl)]			            // is_SetIO
	private static extern int is_SetIO( ref int phCam, int nIO );
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetFlashStrobe",CallingConvention=CallingConvention.Cdecl)]			// is_SetFlashStrobe
	private static extern int is_SetFlashStrobe (int hCam, int nMode, int nField);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetExternalTrigger",CallingConvention=CallingConvention.Cdecl)]		// is_SetExternalTrigger
	private static extern int is_SetExternalTrigger (int hCam, int nTriggerMode);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetRopEffect",CallingConvention=CallingConvention.Cdecl)]				// is_SetRopEffect
	private static extern int is_SetRopEffect (int hCam, int effect, int param, int reserved);
		
	// Camera functions
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_InitCamera",CallingConvention=CallingConvention.Cdecl)]				// is_InitCamera
	private static extern int is_InitCamera( ref int phCam, int hwnd );
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ExitCamera",CallingConvention=CallingConvention.Cdecl)]				// is_ExitCamera
	private static extern int is_ExitCamera (int hCam );
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetCameraInfo",CallingConvention=CallingConvention.Cdecl)]				// is_GetCameraInfo
	private static extern int is_GetCameraInfo (int hCam, byte[] pInfo);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_CameraStatus",CallingConvention=CallingConvention.Cdecl)]				// is_CameraStatus
	private static extern int is_CameraStatus (int hCam, int nInfo, int ulValue);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetCameraType",CallingConvention=CallingConvention.Cdecl)]				// is_GetCameraType
	private static extern int is_GetCameraType(int hCam);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetNumberOfCameras",CallingConvention=CallingConvention.Cdecl)]		// is_GetNumberOfCameras
	private static extern int is_GetNumberOfCameras(ref int pnNumCams);
	
	// Pixelclock
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetPixelClockRange",CallingConvention=CallingConvention.Cdecl)]		// is_GetPixelClockRange
	private static extern int is_GetPixelClockRange (int hCam, ref int pnMin, ref int pnMax);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetPixelClock",CallingConvention=CallingConvention.Cdecl)]				// is_SetPixelClock
	private static extern int is_SetPixelClock (int hCam, int Clock);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetUsedBandwidth",CallingConvention=CallingConvention.Cdecl)]			// is_GetUsedBandwidth
	private static extern int is_GetUsedBandwidth(int hCam); 
	// Framerate
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetFrameTimeRange",CallingConvention=CallingConvention.Cdecl)]			// is_GetFrameTimeRange
	private static extern int is_GetFrameTimeRange (int hCam, ref double min, ref double max, ref double intervall);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetFrameRate",CallingConvention=CallingConvention.Cdecl)]				// is_SetFrameRate
	private static extern int is_SetFrameRate (int hCam, double FPS, ref double newFPS);
	// Exposure
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetExposureRange",CallingConvention=CallingConvention.Cdecl)]			// is_GetExposureRange
	private static extern int is_GetExposureRange (int hCam, ref double min, ref double max, ref double intervall);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetExposureTime",CallingConvention=CallingConvention.Cdecl)]			// is_SetExposureTime
	private static extern int is_SetExposureTime (int hCam, double EXP, ref double newEXP);
	// Get Frames per Second
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetFramesPerSecond",CallingConvention=CallingConvention.Cdecl)]		// is_GetFramesPerSecond
	private static extern int is_GetFramesPerSecond (int hCam, ref double dblFPS);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetIOMask",CallingConvention=CallingConvention.Cdecl)]				    // is_SetIOMask
	private static extern int is_SetIOMask (int hCam, int nMask);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetSensorInfo",CallingConvention=CallingConvention.Cdecl)]				// is_GetSensorInfo
	private static extern int is_GetSensorInfo (int hCam, byte[] pSensorInfo);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetRevisionInfo",CallingConvention=CallingConvention.Cdecl)]			// is_GetRevisionInfo
	private static extern int is_GetRevisionInfo (int hCam, byte[] pRevisionInfo);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_EnableAutoExit",CallingConvention=CallingConvention.Cdecl)]			// is_EnableAutoExit
	private static extern int is_EnableAutoExit (int hCam, int nMode);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_EnableMessage",CallingConvention=CallingConvention.Cdecl)]				// is_EnableMessage
	private static extern int is_EnableMessage (int hCam, int which, int hWnd);    
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetHardwareGain",CallingConvention=CallingConvention.Cdecl)]			// is_SetHardwareGain
	private static extern int is_SetHardwareGain (int hCam, int nMaster, int nRed, int nGreen, int nBlue);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetRenderMode",CallingConvention=CallingConvention.Cdecl)]			    // is_SetRenderMode
	private static extern int is_SetRenderMode (int hCam, int nMode);
		
	// enable/disable WhiteBalance
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetWhiteBalance",CallingConvention=CallingConvention.Cdecl)]			// is_SetWhiteBalance
	private static extern int is_SetWhiteBalance (int hCam, int nMode);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetWhiteBalanceMultipliers",CallingConvention=CallingConvention.Cdecl)]// is_SetWhiteBalanceMultipliers
	private static extern int is_SetWhiteBalanceMultipliers (int hCam, double dblRed, double dblGreen, double dblBlue);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetWhiteBalanceMultipliers",CallingConvention=CallingConvention.Cdecl)]// is_GetWhiteBalanceMultipliers
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetEdgeEnhancement",CallingConvention=CallingConvention.Cdecl)]		// is_SetEdgeEnhancement
	private static extern int is_SetEdgeEnhancement (int hCam, int nEnable);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetColorCorrection",CallingConvention=CallingConvention.Cdecl)]		// is_SetColorCorrection
	private static extern int is_SetColorCorrection (int hCam, int nEnable, double[] factors);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetBlCompensation",CallingConvention=CallingConvention.Cdecl)]			// is_SetBlCompensation
	private static extern int is_SetBlCompensation (int hCam, int nEnable, int offset, int reserved); 
	
	// Hot Pixel Correction
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetBadPixelCorrection",CallingConvention=CallingConvention.Cdecl)]		// is_SetBadPixelCorrection
	private static extern int is_SetBadPixelCorrection (int hCam, int nEnable, int threshold);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_LoadBadPixelCorrectionTable",CallingConvention=CallingConvention.Cdecl)]// is_LoadBadPixelCorrectionTable
	private static extern int is_LoadBadPixelCorrectionTable (int hCam, byte[] File);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SaveBadPixelCorrectionTable",CallingConvention=CallingConvention.Cdecl)]// is_SaveBadPixelCorrectionTable
	private static extern int is_SaveBadPixelCorrectionTable (int hCam, byte[] File);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetBadPixelCorrectionTable",CallingConvention=CallingConvention.Cdecl)]// is_SetBadPixelCorrectionTable
	private static extern int is_SetBadPixelCorrectionTable (int hCam, int nMode, byte[] pList);
	
	// Memoryboard
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetMemoryMode",CallingConvention=CallingConvention.Cdecl)]				// is_SetMemoryMode
	private static extern int is_SetMemoryMode (int hCam, int nCount,int nDelay);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_TransferImage",CallingConvention=CallingConvention.Cdecl)]				// is_TransferImage
	private static extern int is_TransferImage (int hCam, int nMemID, int seqID, int imageNr, int reserved);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_TransferMemorySequence",CallingConvention=CallingConvention.Cdecl)]	// is_TransferMemorySequence
	private static extern int is_TransferMemorySequence (int hCam, int seqID,int StartNr, int nCount, int nSeqPos);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_MemoryFreezeVideo",CallingConvention=CallingConvention.Cdecl)]			// is_MemoryFreezeVideo
	private static extern int is_MemoryFreezeVideo (int hCam, int nMemID, int Wait);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetLastMemorySequence",CallingConvention=CallingConvention.Cdecl)]		// is_GetLastMemorySequence
	private static extern int is_GetLastMemorySequence (int hCam, ref int pID);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetNumberOfMemoryImages",CallingConvention=CallingConvention.Cdecl)]	// is_GetNumberOfMemoryImages
	private static extern int is_GetNumberOfMemoryImages (int hCam, ref int nID, ref int pnCount);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetMemorySequenceWindow",CallingConvention=CallingConvention.Cdecl)]	// is_GetMemorySequenceWindow
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_IsMemoryBoardConnected",CallingConvention=CallingConvention.Cdecl)]	// is_IsMemoryBoardConnected
	private static extern int is_IsMemoryBoardConnected (int hCam, ref byte pConnected);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ResetMemory",CallingConvention=CallingConvention.Cdecl)]				// is_ResetMemory
	private static extern int is_ResetMemory (int hCam, int nReserved);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetSubSampling",CallingConvention=CallingConvention.Cdecl)]			// is_SetSubSampling
	private static extern int is_SetSubSampling (int hCam, int nMode);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ForceTrigger",CallingConvention=CallingConvention.Cdecl)]				// is_ForceTrigger
	private static extern int is_ForceTrigger(int hCam);
		
	// new with driver version 1.12.0006
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetBusSpeed",CallingConvention=CallingConvention.Cdecl)]				// is_GetBusSpeed
	private static extern int is_GetBusSpeed(int hCam);
    
	// new with driver version 1.12.0015
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetBinning",CallingConvention=CallingConvention.Cdecl)]			    // is_SetBinning
	private static extern int is_SetBinning (int hCam, int nMode);
         
	// new with driver version 1.12.0017
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ResetToDefault",CallingConvention=CallingConvention.Cdecl)]		    // is_ResetToDefault
	private static extern int is_ResetToDefault (int hCam);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_LoadParameters",CallingConvention=CallingConvention.Cdecl)]			// is_LoadParameters
	private static extern int is_LoadParameters (int hCam, byte[] pFilename);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SaveParameters",CallingConvention=CallingConvention.Cdecl)]			// is_SaveParameters
	private static extern int is_SaveParameters (int hCam, byte[] pFilename);
   
	// new with driver version 1.14.0001
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetGlobalFlashDelays",CallingConvention=CallingConvention.Cdecl)]	    // is_GetGlobalFlashDelays
	private static extern int is_GetGlobalFlashDelays (int hCam, ref long pulDelay, ref long pulDuration);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetFlashDelay",CallingConvention=CallingConvention.Cdecl)]	            // is_SetFlashDelay
	private static extern int is_SetFlashDelay (int hCam, int ulDelay, int ulDuration);         
	// new with driver version 1.14.0002
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_LoadImage",CallingConvention=CallingConvention.Cdecl)]			        // is_LoadImage
	private static extern int is_LoadImage (int hCam, byte[] pFilename);
  
	// new with driver version 1.14.0008
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetImageAOI",CallingConvention=CallingConvention.Cdecl)]	            // is_SetImageAOI
	private static extern int is_SetImageAOI (int hCam, int xPos, int yPos, int width, int height);    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetCameraID",CallingConvention=CallingConvention.Cdecl)]			    // is_SetCameraID
	private static extern int is_SetCameraID (int hCam, int nID);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetBayerConversion",CallingConvention=CallingConvention.Cdecl)]        // is_SetBayerConversion
	private static extern int is_SetBayerConversion (int hCam, int nMode);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetTestImage",CallingConvention=CallingConvention.Cdecl)]			    // is_SetTestImage
	private static extern int is_SetTestImage (int hCam, int nMode);
	// new with driver version 1.14.0009
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetHardwareGamma",CallingConvention=CallingConvention.Cdecl)]			// is_SetHardwareGamma
	private static extern int is_SetHardwareGamma (int hCam, int nMode);
  
	// new with driver version 2.00.0001
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetCameraList",CallingConvention=CallingConvention.Cdecl)]			    // is_GetCameraList
	private static extern int is_GetCameraList (byte[] pucl);
  
	// new with driver version 2.00.0011
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetAOI",CallingConvention=CallingConvention.Cdecl)]			        // is_SetAOI
	private static extern int is_SetAOI (int hCam, int type, ref int pXPos, ref int pYPos, ref int pWidth, ref int pHeight);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetAutoParameter",CallingConvention=CallingConvention.Cdecl)]          // is_SetAutoParameter
	private static extern int is_SetAutoParameter (int hCam, int param, ref double pval1, ref double pval2);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetAutoInfo",CallingConvention=CallingConvention.Cdecl)]				// is_GetAutoInfo
	private static extern int is_GetAutoInfo (int hCam, byte[] pInfo);

	// new with driver version 2.20.0001
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ConvertImage",CallingConvention=CallingConvention.Cdecl)]				// is_ConvertImage
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetConvertParam",CallingConvention=CallingConvention.Cdecl)]			// is_SetConvertParam
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SaveImageEx",CallingConvention=CallingConvention.Cdecl)]			    // is_SaveImageEx
	private static extern int is_SaveImageEx (int hCam, byte[] File, int fileFormat, int Param);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SaveImageMemEx",CallingConvention=CallingConvention.Cdecl)]			// is_SaveImageMemEx
	private static extern int is_SaveImageMemEx (int hCam, byte[] File, IntPtr pcMem, int nID, int FileFormat, int Param);
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_LoadImageMem",CallingConvention=CallingConvention.Cdecl)]			    // is_LoadImageMem
	private static extern int is_LoadImageMem (int hCam, byte[] File, ref IntPtr ppcImgMem, ref int pid);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetImageHistogram",CallingConvention=CallingConvention.Cdecl)]			// is_GetImageHistogram
	private static extern int is_GetImageHistogram(int hCam, int nID, int ColorMode, IntPtr pHistoMem); 
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetTriggerDelay",CallingConvention=CallingConvention.Cdecl)]			// is_SetTriggerDelay
	private static extern int is_SetTriggerDelay (int hCam, int us);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetGainBoost",CallingConvention=CallingConvention.Cdecl)]			// is_SetGainBoost
	private static extern int is_SetGainBoost (int hCam, int mode);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetLED",CallingConvention=CallingConvention.Cdecl)]			// is_SetLED
	private static extern int is_SetLED (int hCam, int nValue);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetGlobalShutter",CallingConvention=CallingConvention.Cdecl)]			// is_SetGlobalShutter
	private static extern int is_SetGlobalShutter (int hf, int mode );

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetExtendedRegister",CallingConvention=CallingConvention.Cdecl)]			// is_SetExtendedRegister
	private static extern int is_SetExtendedRegister (int hf, int index, ushort val );


	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetHWGainFactor",CallingConvention=CallingConvention.Cdecl)]			// is_SetHWGainFactor
	private static extern int is_SetHWGainFactor (int hCam, int nMode, int nFactor);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_PrepareStealVideo",CallingConvention=CallingConvention.Cdecl)]				// is_PrepareStealVideo
	private static extern int is_PrepareStealVideo (int hCam, int nMode, int StealColorMode);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_Renumerate",CallingConvention=CallingConvention.Cdecl)]				// is_Renumerate
	private static extern int is_Renumerate (int hCam, int nMode);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetExtendedRegister",CallingConvention=CallingConvention.Cdecl)]		// is_GetExtendedRegister
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetHdrMode",CallingConvention=CallingConvention.Cdecl)]			// is_GetHdrMode
	private static extern int is_GetHdrMode (int hCam, ref int Mode);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_EnableHdr",CallingConvention=CallingConvention.Cdecl)]				// is_EnableHdr
	private static extern int is_EnableHdr (int hCam, int Enable);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetHdrKneepoints",CallingConvention=CallingConvention.Cdecl)]		// is_SetHdrKneepoints
	private static extern int is_SetHdrKneepoints (int hCam, byte[] KneepointArray, int KneepointArraySize);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetHdrKneepoints",CallingConvention=CallingConvention.Cdecl)]		// is_GetHdrKneepoints
	private static extern int is_GetHdrKneepoints (int hCam, byte[] KneepointArray, int KneepointArraySize);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetHdrKneepointInfo",CallingConvention=CallingConvention.Cdecl)]		// is_GetHdrKneepointInfo
	private static extern int is_GetHdrKneepointInfo (int hCam, byte[] KneepointInfo, int KneepointInfoSize);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_WriteI2C",CallingConvention=CallingConvention.Cdecl)]		// is_WriteI2C
	private static extern int is_WriteI2C (int hCam, int nDeviceAddr, int nRegisterAddr, byte[] pbData, int nLen);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ReadI2C",CallingConvention=CallingConvention.Cdecl)]		// is_WriteI2C
	private static extern int is_ReadI2C (int hCam, int nDeviceAddr, int nRegisterAddr, byte[] pbData, int nLen);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetOptimalCameraTiming",CallingConvention=CallingConvention.Cdecl)] // is_SetOptimalCameraTiming
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetComportNumber",CallingConvention=CallingConvention.Cdecl)] // is_GetComportNumber
	private static extern int is_GetComportNumber (int hCam, ref uint pComportNumber);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetSupportedTestImages",CallingConvention=CallingConvention.Cdecl)] // is_GetSupportedTestImages
	private static extern int is_GetSupportedTestImages (int hCam, ref int SupportedTestImages);
	
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetTestImageValueRange",CallingConvention=CallingConvention.Cdecl)] // is_GetTestImageValueRange
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetSensorTestImage",CallingConvention=CallingConvention.Cdecl)] // is_SetSensorTestImage
	private static extern int is_SetSensorTestImage (int hCam, int Param1, int Param2);


	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetCameraLUT",CallingConvention=CallingConvention.Cdecl)] // is_SetCameraLUT
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetCameraLUT",CallingConvention=CallingConvention.Cdecl)] // is_GetCameraLUT
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetColorConverter",CallingConvention=CallingConvention.Cdecl)] // is_SetColorConverter
	private static extern int is_SetColorConverter (int hCam, int ColorMode, int ConvertMode);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetColorConverter",CallingConvention=CallingConvention.Cdecl)] // is_GetColorConverter
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetCaptureErrorInfo",CallingConvention=CallingConvention.Cdecl)] // is_GetCaptureErrorInfo
	private static extern int is_GetCaptureErrorInfo (int hCam, byte[] pCaptureErrorInfo, int SizeCaptureErrorInfo);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ResetCaptureErrorInfo",CallingConvention=CallingConvention.Cdecl)] // is_ResetCaptureErrorInfo
	private static extern int is_ResetCaptureErrorInfo (int hCam);


	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_WaitForNextImage",CallingConvention=CallingConvention.Cdecl)]	    // is_WaitForNextImage
	private static extern int is_WaitForNextImage (int hCam, uint timeout, ref IntPtr ppcImg, ref int pid);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_InitImageQueue",CallingConvention=CallingConvention.Cdecl)]        // is_InitImageQueue
	private static extern int is_InitImageQueue (int hCam, int Mode);
    
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_ExitImageQueue",CallingConvention=CallingConvention.Cdecl)]        // is_ExitImageQueue
	private static extern int is_ExitImageQueue (int hCam);


	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetTimeout",CallingConvention=CallingConvention.Cdecl)]			// is_SetTimeout
	private static extern int is_SetTimeout (int hCam, uint Mode, uint Timeout);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetTimeout",CallingConvention=CallingConvention.Cdecl)]			// is_GetTimeout
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetDuration",CallingConvention=CallingConvention.Cdecl)]			// is_GetDuration
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetSensorScalerInfo",CallingConvention=CallingConvention.Cdecl)] // is_GetSensorScalerInfo
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetSensorScaler",CallingConvention=CallingConvention.Cdecl)] // is_SetSensorScaler
	private static extern int is_SetSensorScaler (int hCam, uint nMode, double dblFactor);

	unsafe public struct UC480TIME
	{
		public ushort wYear;
	...
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetImageInfo",CallingConvention=CallingConvention.Cdecl)] // is_GetImageInfo
	private static extern int is_GetImageInfo (int hCam, int nImageBufferID, ref UC480IMAGEINFO pImageInfo, int nImageInfoSize);

	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_DirectRenderer",CallingConvention=CallingConvention.Cdecl)] // is_DirectRenderer
	private static extern int is_DirectRenderer (int hCam, uint nMode, byte [] pParam, uint SizeOfParam);


    [DllImport(DRIVER_DLL_NAME, EntryPoint = "is_ImageFormat",CallingConvention=CallingConvention.Cdecl)] // is_ImageFormat
    ...
    [DllImport(DRIVER_DLL_NAME, EntryPoint = "is_FaceDetection",CallingConvention=CallingConvention.Cdecl)] // is_FaceDetection
    ...
    unsafe public struct FDT_INFO_EL
    {
        ...
        public UC480TIME TimestampSystem;   /* System time stamp (device query time) .                                          */
    ...
    [DllImport(DRIVER_DLL_NAME, EntryPoint = "is_Focus",CallingConvention=CallingConvention.Cdecl)] // is_Focus
    ...
    [DllImport(DRIVER_DLL_NAME, EntryPoint = "is_ImageStabilization",CallingConvention=CallingConvention.Cdecl)] // is_ImageStabilization
	...
	// --------------------------------------------------------------------
    // new exports only valid for uc480 ETH - BEGIN
	// --------------------------------------------------------------------

	// is_GetEthDeviceInfo
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_GetEthDeviceInfo",CallingConvention=CallingConvention.Cdecl)]
	private static extern int is_GetEthDeviceInfo (int hCam, byte[] pDeviceInfo, uint uStructSize);
	
	// is_SetPersistentIpCfg
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetPersistentIpCfg",CallingConvention=CallingConvention.Cdecl)]
	private static extern int is_SetPersistentIpCfg (int hCam, byte[] pIpCfg, uint uStructSize);
	
	// is_SetStarterFirmware
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetStarterFirmware",CallingConvention=CallingConvention.Cdecl)]
	private static extern int is_SetStarterFirmware (int hCam, byte[] pcFilepath, uint uFilepathLen);
	
	// is_SetAutoCfgIpSetup
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetAutoCfgIpSetup",CallingConvention=CallingConvention.Cdecl)]
	private static extern int is_SetAutoCfgIpSetup (int iAdapterID, byte[] pSetup, uint uStructSize);
	
	// is_SetAutoCfgIpSetup
	[DllImport(DRIVER_DLL_NAME ,EntryPoint="is_SetPacketFilter",CallingConvention=CallingConvention.Cdecl)]
	private static extern int is_SetPacketFilter (int iAdapterID, uint uFilterSetting);
	
	// --------------------------------------------------------------------
    // new exports only valid for uc480 ETH - END
	// --------------------------------------------------------------------
	...
	// --------------------------------------------------------------------
    // new wrappers only valid for uc480 ETH - BEGIN
	// --------------------------------------------------------------------
